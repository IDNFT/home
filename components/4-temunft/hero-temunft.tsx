import Thumb from '@/public/illustration/Educate.svg'
import Media from '@/components/media'

export default function HeroTemunft() {
  return (
        ...
        <div className="pt-32 pb-12 md:pt-40 md:pb-20">
          ...
          <div className="text-center pb-12 md:pb-16">
            ...
            <div className="max-w-3xl mx-auto">
              <p className="text-lg text-gray-600 mb-8" data-aos="zoom-y-out" data-aos-delay="150">A roadshow program to various cities in Indonesia for education, socialization, and community engagement in the NFT and Web3 space.</p>
