      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="pt-32 pb-12 md:pt-40 md:pb-20">
          ...
          <ul className="flex mb-4 md:order-1 md:ml-4 md:mb-0">
            <li className="ml-4">
              <a href="#0" className="flex justify-center items-center text-red-700 hover:text-white bg-red-300 hover:bg-rose-700 rounded-lg shadow transition duration-150 ease-in-out" aria-label="Instagram">
            ...
            <li className="ml-4">
              <a href="#0" className="flex justify-center items-center text-red-700 hover:text-white bg-red-300 hover:bg-rose-700 rounded-lg shadow transition duration-150 ease-in-out" aria-label="Twitter">
            ...
            <li className="ml-4">
              <a href="#0" className="flex justify-center items-center text-red-700 hover:text-white bg-red-300 hover:bg-rose-700 rounded-lg shadow transition duration-150 ease-in-out" aria-label="LinkedIn">
                <svg className="w-10 h-10 fill-current" viewBox="-8 -8 32 32" xmlns="http://www.w3.org/2000/svg">
            ...
            <li className="ml-4">
              <a href="#0" className="flex justify-center items-center text-red-700 hover:text-white bg-red-300 hover:bg-rose-700 rounded-lg shadow transition duration-150 ease-in-out" aria-label="Telegram">
                <svg className="w-10 h-10 fill-current" viewBox="-8 -8 32 32" xmlns="http://www.w3.org/2000/svg">
