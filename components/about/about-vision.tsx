            ...
            <div className="pb-6 md:pb-6">
              ...
              <div className="max-x-3xl mx-auto grid gap-12 px-4 sm:px-8">
                ...
                <div className="max-x-3xl mx-auto md:grid md:grid-cols-12 md:gap-6 items-center">
                  ...
                  <div className="max-w-xl md:max-w-none md:w-full mx-auto md:col-span-7 lg:col-span-6" data-aos="fade-right">
                    <div className="md:pr-4 lg:pr-12 xl:pr-16">
                      <h2 className="text-2xl mb-3 font-bold text-gray-600">Embrace</h2>
                ...
                <div className="md:grid md:grid-cols-12 md:gap-6 items-center">
                  {/* Image */}
                  <div className="max-w-xl md:max-w-none md:w-full mx-auto md:col-span-5 lg:col-span-6 mb-8 md:mb-0 md:order-1 rtl" data-aos="fade-up">
                  ...
                  <div className="max-w-xl md:max-w-none md:w-full mx-auto md:col-span-7 lg:col-span-6" data-aos="fade-left">
                    <div className="md:pl-4 lg:pl-12 xl:pl-16">
                      <h2 className="text-2xl mb-3 font-bold text-gray-600">Educate</h2>
                ...
                <div className="md:grid md:grid-cols-12 md:gap-6 items-center">
                  ...
                  <div className="max-w-xl md:max-w-none md:w-full mx-auto md:col-span-7 lg:col-span-6" data-aos="fade-right">
                    <div className="md:pr-4 lg:pr-12 xl:pr-16">
                      <h2 className="text-2xl mb-3 font-bold text-gray-600">Empower</h2>
